...
DEBUG_MODE = True
from backend.settings import SSL_KEYS
# clear tables
...
sio = socketio.AsyncServer(async_mode='tornado', logger=True, cors_allowed_origins=[
    ...
    '172.17.8.254',
    'http://172.17.8.254',
    'https://dating-test.webmonstr.com',
    'https://socket.neuraldating.com',
    'https://neuraldating.com',
    'https://neuraldating.com:8889',
    'https://dev.neuraldating.com',
    'https://dev.neuraldating.com:8889',
